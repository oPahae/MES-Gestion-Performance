...
export const URGENCE_INFO = {
  faible: { label: "Faible", color: "#43A047", bg: "bg-green-50", border: "border-green-200", text: "text-green-700" },
  moyenne: { label: "Moyenne", color: "#FB8C00", bg: "bg-amber-50", border: "border-amber-200", text: "text-amber-700" },
  critique: { label: "Critique", color: "#E53935", bg: "bg-red-50", border: "border-red-300", text: "text-red-700" },
};

export const TEMPS_RALENTISSEMENT_ALERT_RATIO = 0.3;

export const TEMPS_FORMULAS = {
  tempsRequis: "Temps requis = Temps d'ouverture − Temps planifié",
  tempsFonctionnement: "Temps de fonctionnement = Temps requis − (Arrêt machine + Changement série + Rupture stock + Autre)",
  tempsUtile: "Temps utile = Σ (Temps de gamme × Quantité produite)",
  tempsNonQualite: "Temps de non qualité = Σ (Temps de gamme × Nombre de rebuts)",
  tempsNet: "Temps net = Temps utile + Temps de non qualité",
  tempsRalentissement: "Temps de ralentissement = Temps de fonctionnement − Temps net",
  disponibilite: "Taux de disponibilité = Temps de fonctionnement / Temps requis",
  performance: "Taux de performance = Temps net / Temps requis",
  qualite: "Taux de qualité = Temps utile / Temps requis",
};